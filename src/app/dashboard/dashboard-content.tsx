        ...
        <div className="flex-1 overflow-auto">
          ...
          {activePage === 'calendar' && (
            <div className="flex h-full flex-col">
              {/* Social Media Platform Buttons and Approval Indicator */}
              <div className="flex items-center justify-between p-4 bg-slate-800 border-b border-slate-700">
                <div className="flex space-x-4">
                  {/* Circular buttons for social media platforms */}
                  ...
                  <button className="w-10 h-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white hover:opacity-90 transition-opacity">
                  ...
                  <button className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-black hover:bg-gray-300 transition-colors">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-yellow-400 text-sm font-medium">Post Under Approval</span>
                </div>
              </div>
